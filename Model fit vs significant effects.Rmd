...
# Finding out what's the best theory is?
...
llm1<-0.5 * (sum(log(w)) - nm1 * (log(2 * pi) + 1 - log(nm1) + log(sum(w * resm1^2))))
llm2<-0.5 * (sum(log(w)) - nm2 * (log(2 * pi) + 1 - log(nm2) + log(sum(w * resm2^2))))
